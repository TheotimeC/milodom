        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              url: siteConfig.url,
              areaServed: { "@type": "City", name: "Haguenau et alentours, Strasbourg" },
              address: { "@type": "PostalAddress", addressLocality: "Haguenau et alentours, Strasbourg", addressCountry: "FR" },
